// Creator choice page for session creators choosing between receipt upload and manual entry.
...
export interface CreatorChoicePageProps {
...
export function CreatorChoicePage({
  ...
  return (
    <div className="calculator-choice-container">
      ...
      />
      <h2>How would you like to set up the bill?</h2>
